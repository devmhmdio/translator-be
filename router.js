...
const { getUsers, createUser, updateUser, getUserById, deleteUser, getUserByIts, getWriters, getGlossaryWriters } = require('./controllers/User');
...
router.get('/glossary-writers', getGlossaryWriters);
